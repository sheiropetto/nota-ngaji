                    ...
                    {dayItems.map((item) => (
                      <div key={item.id} className="group relative flex items-start gap-4 rounded-3xl bg-white p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all">
                        ...
                        <div className="relative">
                          <button onClick={(e) => { e.stopPropagation(); setActiveMenuId(activeMenuId === item.id ? null : item.id); }} className="p-2 text-gray-400 active:bg-gray-100 rounded-full transition-colors">
