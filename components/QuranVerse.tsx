...
export default function QuranVerse() {
  ...
  if (loading) {
    return (
      <div className="w-full max-w-2xl animate-pulse space-y-3 rounded-xl border border-[#00C9A7]/10 bg-[#00C9A7]/5 p-6">
        <div className="h-4 w-3/4 rounded bg-[#00C9A7]/30"></div>
        <div className="h-4 w-1/2 rounded bg-[#00C9A7]/30"></div>
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-[#00C9A7]/20 bg-white p-8 text-center shadow-xl shadow-[#00C9A7]/10">
