...
export default function Navbar() {
  ...
  return (
    <>
      ...
      */}
      <header className="fixed top-0 left-1/2 -translate-x-1/2 z-40 w-full max-w-md h-14 flex items-center justify-center px-4 bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl border-b border-white/20 dark:border-white/5 shadow-sm transition-colors duration-300">
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[60] w-[92%] max-w-md pointer-events-none">
        <nav className="pointer-events-auto relative overflow-hidden rounded-full border border-white/40 bg-white/40 dark:bg-gray-900/60 dark:border-white/10 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] backdrop-blur-2xl transition-colors duration-300">
