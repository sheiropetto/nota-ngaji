...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Header (Branding + Desktop Nav) */}
      ...
      <nav className="fixed bottom-0 w-full max-w-md bg-white border-t border-gray-100 z-50 left-1/2 -translate-x-1/2 pb-safe">
              ...
              >
                <div
                  className={`flex flex-col items-center justify-center w-12 h-12 rounded-2xl transition-all duration-300 ease-out ${
                    isActive
                      ? "bg-emerald-50 -translate-y-3 shadow-md border border-emerald-100"
                ...
                {isActive && (
                  <span className="absolute bottom-1 text-[10px] font-bold text-emerald-600 transition-opacity duration-300">
                    {item.name}
                  </span>
                )}
              </Link>
